...
class RvizClicker:
    ...
    def __init__(self):
        ...
        self.TrackingFrame = "eagle/ekf"
        self.ClickerToMapZ = 0
        ...
        self.tf_timer = rospy.Timer(rospy.Duration(0.1), self.tf_loop)
    ...
    def tf_loop(self, msg):
        try:
            (trans,rot) = self.listener.lookupTransform(self.WaypointFrame, self.TrackingFrame, rospy.Time(0))
        except (tf.LookupException, tf.ConnectivityException, tf.ExtrapolationException):
            return

        self.ClickerToMapZ = trans[2]
